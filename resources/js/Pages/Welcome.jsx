...
export default function Welcome({ auth }) {
    ...
    const appName = import.meta.env.VITE_APP_NAME || "Seu Gerenciador";
            ...
            <div className="bg-gradient-to-r from-purple-500 to-blue-900 min-h-screen flex flex-col justify-center items-center text-white">
                <header className="text-center">
                    ...
                    <p className="text-lg mb-10">
                        Controle despesas, organize e mantenha os colaboradores
                        informados.
                    </p>
                </header>
                ...
                <section className="mt-12 flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6">
                    ...
                    <div className="bg-white text-black p-6 rounded-lg shadow-lg w-72 text-center">
                        ...
                        <p>
                            Monitore todas as despesas, garantindo transparência
                            e controle.
                        </p>
                    </div>
                    ...
                    <div className="bg-white text-black p-6 rounded-lg shadow-lg w-72 text-center">
                        ...
                        <p>
                            Mantenha os colaboradores informados com
                            comunicados.
                        </p>
                    </div>
                    ...
                    <div className="bg-white text-black p-6 rounded-lg shadow-lg w-72 text-center">
                        ...
                        <p>
                            Acesse relatórios financeiros e documentos com
                            facilidade.
                        </p>
                    </div>
                </section>
